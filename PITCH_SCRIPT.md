...
- This is ONE continuous story, not 5 slides read aloud. Practice until one part follows the next like a song.
- Dashes (—) are breath pauses. Commas keep momentum. Periods are emphasis beats — slow down and land them.
- Transitions are causal ("so", "because"), never sequential ("next, let me show you").
- Open broad, narrow to gaming, show the product, expand back out. The close echoes the open.
...
- [x] Don't show five features — one flow, polished
- [x] Don't name specific companies — talk about the market
- [x] No "That's [Product]" formula
- [x] No "it's not X, it's Y" contrasts
- [x] No bullet-point lists spoken aloud — everything connects causally
